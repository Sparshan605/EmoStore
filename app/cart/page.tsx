        ...
        <section className="mx-auto max-w-4xl px-6 py-12 md:px-10">
          ...
          {items.length === 0 ? (
            <div className="py-24 text-center">
              ...
              <Link
                href="/shop"
                className="rounded-full border border-white/30 px-6 py-3 text-sm hover:bg-white hover:text-black transition"
                style={{ fontFamily: "Work Sans, sans-serif" }}
              >
                Browse Shop
              </Link>
            ...
            <div className="flex flex-col gap-12 lg:flex-row">
              ...
              <div className="flex-1 space-y-4">
                {items.map((item) => (
                  <div
                    key={item.id}
                    className="flex gap-4 rounded-2xl border border-white/10 bg-zinc-800 p-4"
                  >
                    {/* Product image */}
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-3">
                        <button
                          ...
                          className="w-7 h-7 rounded-full border border-white/20 hover:bg-white hover:text-black transition text-sm"
                        >
                          −
                        </button>
                    ...
                    <button
                      ...
                      className="text-white/20 hover:text-red-400 transition text-xs self-start mt-1"
                    >
                      ✕
                    </button>
                  </div>
              ...
              <div className="w-full lg:w-72">
                <div className="rounded-2xl border border-white/10 bg-zinc-800 p-6 sticky top-24">
                  ...
                  <Link
                    href="/shop"
                    className="block text-center mt-4 text-xs text-white/30 hover:text-white transition"
                    style={{ fontFamily: "Work Sans, sans-serif" }}
                  >
                    Continue Shopping
                  </Link>
