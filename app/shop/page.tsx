      ...
      switch (sortBy) {
        ...
        default: {
          const score = (product: Product) => {
            let total = 0;
            if (product.tag === "Popular") total += 3;
            if (product.tag === "New") total += 2;
            if ((product.stock ?? 0) > 0) total += 1;
        ...
        <section className="mx-auto max-w-7xl px-6 py-12 md:px-10 lg:px-12">
          ...
          <div className="mb-8 grid gap-4 lg:grid-cols-[1.25fr_0.75fr_auto]">
            <div>
              <label
                ...
                className="mb-2 block text-xs uppercase tracking-[0.22em] text-white/50"
                style={{ fontFamily: "Work Sans, sans-serif" }}
              >
                Search
              </label>
            ...
            <div className="flex items-end">
              <Link
                href="/orders"
                className="w-full rounded-full border border-white/30 px-5 py-3 text-center text-sm transition hover:bg-white hover:text-black lg:w-auto"
                style={{ fontFamily: "Work Sans, sans-serif" }}
              >
                View Orders
              </Link>
          ...
          <div className="mb-10 flex flex-wrap gap-2">
            ...
            {hasActiveFilters && (
              <button
                ...
                className="rounded-full border border-red-400/30 px-4 py-2 text-xs uppercase tracking-widest text-red-300 transition hover:border-red-400 hover:text-red-200"
                style={{ fontFamily: "Work Sans, sans-serif" }}
              >
                Clear
              </button>
          ...
          {loading ? (
            ...
            <div className="rounded-2xl border border-white/10 bg-zinc-900 px-6 py-16 text-center">
              ...
              <button
                onClick={resetFilters}
                className="mt-6 rounded-full border border-white/25 px-5 py-2 text-sm transition hover:bg-white hover:text-black"
                style={{ fontFamily: "Work Sans, sans-serif" }}
              >
                Reset Filters
              </button>
                  ...
                  >
                    ...
                    <div className="mt-6 flex items-center justify-between">
                      <div className="flex flex-col gap-1">
                        ...
                        <span
                          className={`text-xs ${
                            oos ? "text-red-400" : "text-white/40"
                          }`}
                          style={{ fontFamily: "Work Sans, sans-serif" }}
                        >
